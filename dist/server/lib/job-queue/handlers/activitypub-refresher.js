...
function refreshVideo(videoUrl) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const videoFromDatabase = yield model_loaders_1.loadVideoByUrl(videoUrl, fetchType);
...
function refreshActor(actorUrl) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (actor) {
            yield actors_1.refreshActorIfNeeded({ actor, fetchedType: fetchType });
        }
    });
}
function refreshVideoPlaylist(playlistUrl) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (playlist) {
            yield playlists_1.refreshVideoPlaylistIfNeeded(playlist);
        }
    });
}
