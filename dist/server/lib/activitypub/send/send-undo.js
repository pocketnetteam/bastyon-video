...
function sendUndoFollow(actorFollow, t) {
    ...
    const undoUrl = (0, url_1.getUndoActivityPubUrl)(actorFollow.url);
    const followActivity = (0, send_follow_1.buildFollowActivity)(actorFollow.url, me, following);
    const undoActivity = undoActivityData(undoUrl, me, followActivity);
    t.afterCommit(() => (0, utils_1.unicastTo)(undoActivity, me, following.inboxUrl));
}
...
function sendUndoAnnounce(byActor, videoShare, video, t) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const undoUrl = (0, url_1.getUndoActivityPubUrl)(videoShare.url);
        const { activity: announceActivity, actorsInvolvedInVideo } = yield (0, send_announce_1.buildAnnounceWithVideoAudience)(byActor, videoShare, video, t);
        const undoActivity = undoActivityData(undoUrl, byActor, announceActivity);
        const followersException = [byActor];
        return (0, utils_1.broadcastToFollowers)(undoActivity, byActor, actorsInvolvedInVideo, t, followersException);
    });
}
...
function sendUndoLike(byActor, video, t) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const likeUrl = (0, url_1.getVideoLikeActivityPubUrlByLocalActor)(byActor, video);
        const likeActivity = (0, send_like_1.buildLikeActivity)(likeUrl, byActor, video);
...
function sendUndoDislike(byActor, video, t) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const dislikeUrl = (0, url_1.getVideoDislikeActivityPubUrlByLocalActor)(byActor, video);
        const dislikeActivity = (0, send_dislike_1.buildDislikeActivity)(dislikeUrl, byActor, video);
...
function sendUndoVideoRelatedActivity(options) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        const activityBuilder = (audience) => {
            const undoUrl = (0, url_1.getUndoActivityPubUrl)(options.url);
