...
function sendDeleteVideo(video, transaction) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const activityBuilder = (audience) => {
            const url = (0, url_1.getDeleteActivityPubUrl)(video.url);
            return buildDeleteActivity(url, video.url, byActor, audience);
        };
        return (0, utils_1.sendVideoRelatedActivity)(activityBuilder, { byActor, video, transaction });
    });
}
...
function sendDeleteActor(byActor, t) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const url = (0, url_1.getDeleteActivityPubUrl)(byActor.url);
        ...
        return (0, utils_1.broadcastToFollowers)(activity, byActor, actorsInvolved, t);
    });
}
...
function sendDeleteVideoComment(videoComment, t) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const url = (0, url_1.getDeleteActivityPubUrl)(videoComment.url);
        ...
        const actorsInvolvedInComment = yield (0, audience_1.getActorsInvolvedInVideo)(videoComment.Video, t);
        actorsInvolvedInComment.push(byActor);
        const audience = (0, audience_1.getVideoCommentAudience)(videoComment, threadParentCommentsFiltered, actorsInvolvedInComment, isVideoOrigin);
        const activity = buildDeleteActivity(url, videoComment.url, byActor, audience);
        const actorsException = [byActor];
        yield (0, utils_1.broadcastToActors)(activity, byActor, threadParentCommentsFiltered.map(c => c.Account.Actor), t, actorsException);
        yield (0, utils_1.broadcastToFollowers)(activity, byActor, [byActor], t);
        if (isVideoOrigin)
            return (0, utils_1.broadcastToFollowers)(activity, byActor, actorsInvolvedInComment, t, actorsException);
        t.afterCommit(() => (0, utils_1.unicastTo)(activity, byActor, videoComment.Video.VideoChannel.Account.Actor.getSharedInbox()));
    });
}
...
function sendDeleteVideoPlaylist(videoPlaylist, t) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const url = (0, url_1.getDeleteActivityPubUrl)(videoPlaylist.url);
        ...
        return (0, utils_1.broadcastToFollowers)(activity, byActor, toFollowersOf, t);
    });
}
...
function buildDeleteActivity(url, object, byActor, audience) {
    ...
    if (audience)
        return (0, audience_1.audiencify)(activity, audience);
    return activity;
}
