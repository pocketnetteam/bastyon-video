...
function sendUpdateVideo(videoArg, t, overrodeByActor) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const url = (0, url_1.getUpdateActivityPubUrl)(video.url, video.updatedAt.toISOString());
        ...
        return (0, utils_1.broadcastToFollowers)(updateActivity, byActor, actorsInvolved, t);
    });
}
...
function sendUpdateActor(accountOrChannel, t) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const url = (0, url_1.getUpdateActivityPubUrl)(byActor.url, byActor.updatedAt.toISOString());
        const accountOrChannelObject = accountOrChannel.toActivityPubObject();
        const audience = (0, audience_1.getAudience)(byActor);
...
function sendUpdateCacheFile(byActor, redundancyModel) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const activityBuilder = (audience) => {
            ...
            const url = (0, url_1.getUpdateActivityPubUrl)(redundancyModel.url, redundancyModel.updatedAt.toISOString());
            return buildUpdateActivity(url, byActor, redundancyObject, audience);
        };
        return (0, utils_1.sendVideoRelatedActivity)(activityBuilder, { byActor, video, contextType: 'CacheFile' });
    });
}
...
function sendUpdateVideoPlaylist(videoPlaylist, t) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const url = (0, url_1.getUpdateActivityPubUrl)(videoPlaylist.url, videoPlaylist.updatedAt.toISOString());
        const object = yield videoPlaylist.toActivityPubObject(null, t);
        const audience = (0, audience_1.getAudience)(byActor, videoPlaylist.privacy === 1);
        ...
        return (0, utils_1.broadcastToFollowers)(updateActivity, byActor, toFollowersOf, t);
    });
}
