...
function getOrCreateAPVideoPlaylist(playlistObjectArg) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        const playlistUrl = (0, activitypub_1.getAPId)(playlistObjectArg);
        ...
        if (playlistFromDatabase) {
            (0, refresh_1.scheduleRefreshIfNeeded)(playlistFromDatabase);
        ...
        const playlistCreated = yield (0, create_update_1.createOrUpdateVideoPlaylist)(playlistObject);
