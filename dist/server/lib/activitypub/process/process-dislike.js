...
function processDislikeActivity(options) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        return (0, database_utils_1.retryTransactionWrapper)(processDislike, activity, byActor);
    });
}
...
function processDislike(activity, byActor) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const { video } = yield (0, videos_1.getOrCreateAPVideo)({ videoObject: dislikeObject });
