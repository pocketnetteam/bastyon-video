...
function updateMasterHLSPlaylist(video, playlist) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        for (const file of playlist.VideoFiles) {
            ...
            yield video_path_manager_1.VideoPathManager.Instance.makeAvailableVideoFile(playlist, file, (videoFilePath) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const codecs = yield Promise.all([
                    ffprobe_utils_1.getVideoStreamCodec(videoFilePath),
                    ffprobe_utils_1.getAudioStreamCodec(videoFilePath)
                ]);
        ...
        yield video_path_manager_1.VideoPathManager.Instance.makeAvailablePlaylistFile(playlist, playlist.playlistFilename, masterPlaylistPath => {
            return fs_extra_1.writeFile(masterPlaylistPath, masterPlaylists.join('\n') + '\n');
        });
    });
}
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        for (const file of playlist.VideoFiles) {
            ...
            yield video_path_manager_1.VideoPathManager.Instance.makeAvailableVideoFile(playlist, file, videoPath => {
                return video_path_manager_1.VideoPathManager.Instance.makeAvailableResolutionPlaylistFile(playlist, file, (resolutionPlaylistPath) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const playlistContent = yield fs_extra_1.readFile(resolutionPlaylistPath);
...
function downloadPlaylistSegments(playlistUrl, destinationDir, timeout, bodyKBLimit) {
    ...
    return new Promise((res, rej) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            for (const fileUrl of fileUrls) {
                ...
                yield requests_1.doRequestAndSaveToFile(fileUrl, destPath, { bodyKBLimit: remainingBodyKBLimit });
                const { size } = yield fs_extra_1.stat(destPath);
    ...
    function fetchUniqUrls(playlistUrl) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { body } = yield requests_1.doRequest(playlistUrl);
            if (!body)
                return [];
