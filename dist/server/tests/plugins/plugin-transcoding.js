    ...
    describe('When using a plugin adding profiles to existing encoders', function () {
        ...
        it('Should have the appropriate available profiles', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                chai_1.expect(config.transcoding.availableProfiles).to.have.members(['default', 'low-vod', 'input-options-vod', 'bad-scale-vod']);
                chai_1.expect(config.live.transcoding.availableProfiles).to.have.members(['default', 'high-live', 'input-options-live', 'bad-scale-live']);
            });
        });
        describe('VOD', function () {
            ...
            it('Should apply the scale filter in vod profile', function () {
                return tslib_1.__awaiter(this, void 0, void 0, function* () {
                    ...
                    chai_1.expect(video.files).to.have.lengthOf(1);
                    chai_1.expect(video.streamingPlaylists).to.have.lengthOf(0);
                });
            });
        });
