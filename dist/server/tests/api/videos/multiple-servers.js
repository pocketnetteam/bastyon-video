        ...
        it('Should upload the video on server 1 and propagate on each server', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                for (const server of servers) {
                    ...
                    const video = data[0];
                    yield (0, extra_utils_1.completeVideoCheck)(server, video, checkAttributes);
        ...
        it('Should upload two videos on server 3 and propagate on each server', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                for (const server of servers) {
                    ...
                    yield (0, extra_utils_1.completeVideoCheck)(server, video1, checkAttributesVideo1);
                    ...
                    yield (0, extra_utils_1.completeVideoCheck)(server, video2, checkAttributesVideo2);
                }
            });
        });
    });
    ...
    describe('Should seed the uploaded video', function () {
        it('Should add the file 1 by asking server 3', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                const torrent = yield (0, extra_utils_1.webtorrentAdd)(videoDetails.files[0].magnetUri, true);
        ...
        it('Should add the file 3-2 by asking server 1', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                const video = data[3];
                const videoDetails = yield servers[0].videos.get({ id: video.id });
                const torrent = yield (0, extra_utils_1.webtorrentAdd)(videoDetails.files[0].magnetUri);
                expect(torrent.files).to.be.an('array');
                expect(torrent.files.length).to.equal(1);
                expect(torrent.files[0].path).to.exist.and.to.not.equal('');
            });
        ...
        it('Should add the file 2 in 360p by asking server 1', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                const torrent = yield (0, extra_utils_1.webtorrentAdd)(file.magnetUri);
                expect(torrent.files).to.be.an('array');
                expect(torrent.files.length).to.equal(1);
                expect(torrent.files[0].path).to.exist.and.to.not.equal('');
            });
    ...
    describe('Should update video views, likes and dislikes', function () {
        ...
        it('Should view multiple videos on each servers', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.waitJobs)(servers);
                yield (0, extra_utils_1.wait)(16000);
                yield (0, extra_utils_1.waitJobs)(servers);
                let baseVideos = null;
                for (const server of servers) {
                    const { data } = yield server.videos.list();
        ...
        it('Should have the video 3 updated on each server', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                for (const server of servers) {
                    ...
                    yield (0, extra_utils_1.completeVideoCheck)(server, videoUpdated, checkAttributes);
                }
            });
        });
        it('Should remove the videos 3 and 3-2 by asking server 3 and correctly delete files', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                for (const id of [toRemove[0].id, toRemove[1].id]) {
                    yield (0, extra_utils_1.saveVideoInServers)(servers, id);
            ...
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                for (const server of servers) {
                    ...
                    }
                    {
                        ...
                        expect((0, extra_utils_1.dateIsValid)(deletedComment.createdAt)).to.be.true;
                        expect((0, extra_utils_1.dateIsValid)(deletedComment.updatedAt)).to.be.true;
    ...
    describe('With minimum parameters', function () {
        it('Should upload and propagate the video', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                const req = (0, supertest_1.default)(servers[1].url)
                    .post(path)
                    ...
                    .field('privacy', '1')
                    .field('channelId', '1');
                yield req.attach('videofile', (0, extra_utils_1.buildAbsoluteFixturePath)('video_short.webm'))
