...
describe('Object storage for video import', function () {
    ...
    before(function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            server = yield (0, extra_utils_1.createSingleServer)(1, extra_utils_1.ObjectStorageCommand.getDefaultConfig());
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            it('Should import a video and have sent it to object storage', function () {
                return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    (0, extra_utils_1.expectStartWith)(fileUrl, extra_utils_1.ObjectStorageCommand.getWebTorrentBaseUrl());
                    yield (0, extra_utils_1.makeRawRequest)(fileUrl, models_1.HttpStatusCode.OK_200);
                });
            });
        });
    });
