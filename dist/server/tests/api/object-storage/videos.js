...
function checkFiles(options) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        for (const file of video.files) {
            ...
            (0, extra_utils_1.expectStartWith)(file.fileUrl, start);
            const res = yield (0, extra_utils_1.makeRawRequest)(file.fileDownloadUrl, models_1.HttpStatusCode.FOUND_302);
            const location = res.headers['location'];
            (0, extra_utils_1.expectStartWith)(location, start);
            yield (0, extra_utils_1.makeRawRequest)(location, models_1.HttpStatusCode.OK_200);
        }
        ...
        if (hls) {
            ...
            const start = baseUrl + prefix;
            (0, extra_utils_1.expectStartWith)(hls.playlistUrl, start);
            (0, extra_utils_1.expectStartWith)(hls.segmentsSha256Url, start);
            yield (0, extra_utils_1.makeRawRequest)(hls.playlistUrl, models_1.HttpStatusCode.OK_200);
            const resSha = yield (0, extra_utils_1.makeRawRequest)(hls.segmentsSha256Url, models_1.HttpStatusCode.OK_200);
        ...
        for (const file of allFiles) {
            ...
            const res = yield (0, extra_utils_1.makeRawRequest)(file.fileUrl, models_1.HttpStatusCode.OK_200);
...
function runTestSuite(options) {
    ...
    it('Should correctly delete the files', function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            for (const url of deletedUrls) {
                yield (0, extra_utils_1.makeRawRequest)(url, models_1.HttpStatusCode.NOT_FOUND_404);
            }
        });
    });
    ...
    it('Should not have downloaded files from object storage', function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            for (const server of servers) {
                yield (0, extra_utils_1.expectLogDoesNotContain)(server, 'from object storage');
            }
        });
    });
    after(function () {
...
describe('Object storage for videos', function () {
    ...
    describe('Test config', function () {
        ...
        it('Should fail with same bucket names without prefix', function (done) {
            ...
            (0, extra_utils_1.createSingleServer)(1, config)
        ...
        it('Should fail with bad credentials', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.waitJobs)([server], true);
                const video = yield server.videos.get({ id: uuid });
                (0, extra_utils_1.expectStartWith)(video.files[0].fileUrl, server.url);
        ...
        it('Should succeed with credentials from env', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.waitJobs)([server], true);
                const video = yield server.videos.get({ id: uuid });
                (0, extra_utils_1.expectStartWith)(video.files[0].fileUrl, extra_utils_1.ObjectStorageCommand.getWebTorrentBaseUrl());
            });
        });
        after(function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
