...
describe('Test video playlists API validator', function () {
    ...
    describe('When listing playlists', function () {
        ...
        it('Should fail with a bad start pagination', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.checkBadStartPagination(server.url, globalPath, server.accessToken);
                yield extra_utils_1.checkBadStartPagination(server.url, accountPath, server.accessToken);
                yield extra_utils_1.checkBadStartPagination(server.url, videoChannelPath, server.accessToken);
            });
        });
        it('Should fail with a bad count pagination', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.checkBadCountPagination(server.url, globalPath, server.accessToken);
                yield extra_utils_1.checkBadCountPagination(server.url, accountPath, server.accessToken);
                yield extra_utils_1.checkBadCountPagination(server.url, videoChannelPath, server.accessToken);
            });
        });
        it('Should fail with an incorrect sort', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.checkBadSortPagination(server.url, globalPath, server.accessToken);
                yield extra_utils_1.checkBadSortPagination(server.url, accountPath, server.accessToken);
        ...
        it('Should success with the correct parameters', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.makeGetRequest({ url: server.url, path: globalPath, expectedStatus: models_1.HttpStatusCode.OK_200, token: server.accessToken });
                yield extra_utils_1.makeGetRequest({ url: server.url, path: accountPath, expectedStatus: models_1.HttpStatusCode.OK_200, token: server.accessToken });
                yield extra_utils_1.makeGetRequest({
                    url: server.url,
    ...
    describe('When listing videos of a playlist', function () {
        ...
        it('Should fail with a bad start pagination', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.checkBadStartPagination(server.url, path + playlist.shortUUID + '/videos', server.accessToken);
            });
        });
        it('Should fail with a bad count pagination', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.checkBadCountPagination(server.url, path + playlist.shortUUID + '/videos', server.accessToken);
            });
        });
        it('Should success with the correct parameters', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.makeGetRequest({ url: server.url, path: path + playlist.shortUUID + '/videos', expectedStatus: models_1.HttpStatusCode.OK_200 });
            });
        });
    });
