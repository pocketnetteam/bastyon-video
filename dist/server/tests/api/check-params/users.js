...
describe('Test users API validators', function () {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            overrideConfig = { signup: { limit: 8 } };
            {
                const res = yield Promise.all([
                    (0, extra_utils_1.createSingleServer)(1, overrideConfig),
                    (0, extra_utils_1.createSingleServer)(2)
                ]);
                server = res[0];
    ...
    describe('When adding a new user', function () {
        ...
        it('Should fail with a missing email', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                const fields = (0, lodash_1.omit)(baseCorrectParams, 'email');
                yield (0, extra_utils_1.makePostBodyRequest)({ url: server.url, path, token: server.accessToken, fields });
            });
        });
        ...
        it('Should fail without a videoQuota', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                const fields = (0, lodash_1.omit)(baseCorrectParams, 'videoQuota');
                yield (0, extra_utils_1.makePostBodyRequest)({ url: server.url, path, token: server.accessToken, fields });
            });
        });
        it('Should fail without a videoQuotaDaily', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                const fields = (0, lodash_1.omit)(baseCorrectParams, 'videoQuotaDaily');
                yield (0, extra_utils_1.makePostBodyRequest)({ url: server.url, path, token: server.accessToken, fields });
            });
        });
        ...
        it('Should fail without a user role', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                const fields = (0, lodash_1.omit)(baseCorrectParams, 'role');
                yield (0, extra_utils_1.makePostBodyRequest)({ url: server.url, path, token: server.accessToken, fields });
            });
        });
        ...
        it('Should fail with a non admin user', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.makePostBodyRequest)({ url: server.url, path, token: userToken, fields, expectedStatus: models_1.HttpStatusCode.FORBIDDEN_403 });
            });
        });
    });
    describe('When updating my account', function () {
        it('Should fail with an invalid email attribute', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.makePutBodyRequest)({ url: server.url, path: path + 'me', token: server.accessToken, fields });
            });
        });
        it('Should fail with a too small password', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.makePutBodyRequest)({ url: server.url, path: path + 'me', token: userToken, fields });
            });
        });
        it('Should fail with a too long password', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
    ...
    describe('When updating my avatar', function () {
        it('Should fail without an incorrect input file', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                const fields = {};
                const attaches = {
                    avatarfile: (0, extra_utils_1.buildAbsoluteFixturePath)('video_short.mp4')
                };
                yield (0, extra_utils_1.makeUploadRequest)({ url: server.url, path: path + '/me/avatar/pick', token: server.accessToken, fields, attaches });
            });
        });
        it('Should fail with a big file', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                const fields = {};
                const attaches = {
                    avatarfile: (0, extra_utils_1.buildAbsoluteFixturePath)('avatar-big.png')
                };
                yield (0, extra_utils_1.makeUploadRequest)({ url: server.url, path: path + '/me/avatar/pick', token: server.accessToken, fields, attaches });
            });
        });
        it('Should fail with an unauthenticated user', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                const fields = {};
                const attaches = {
                    avatarfile: (0, extra_utils_1.buildAbsoluteFixturePath)('avatar.png')
                };
    ...
    describe('When getting a user', function () {
        ...
        it('Should fail with a non admin user', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                yield (0, extra_utils_1.makeGetRequest)({ url: server.url, path, token: userToken, expectedStatus: models_1.HttpStatusCode.FORBIDDEN_403 });
            });
        });
        it('Should succeed with the correct params', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                yield (0, extra_utils_1.makeGetRequest)({ url: server.url, path: path + userId, token: server.accessToken, expectedStatus: models_1.HttpStatusCode.OK_200 });
            });
        });
    });
    describe('When updating a user', function () {
        it('Should fail with an invalid email attribute', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.makePutBodyRequest)({ url: server.url, path: path + userId, token: server.accessToken, fields });
            });
        });
        ...
        it('Should fail when updating root role', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.makePutBodyRequest)({ url: server.url, path: path + rootId, token: server.accessToken, fields });
            });
        });
        it('Should fail with invalid admin flags', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
    ...
    describe('When retrieving my global ratings', function () {
        ...
        it('Should fail with a unauthenticated user', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                yield (0, extra_utils_1.makeGetRequest)({ url: server.url, path, expectedStatus: models_1.HttpStatusCode.UNAUTHORIZED_401 });
            });
        });
        it('Should fail with a another user', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                yield (0, extra_utils_1.makeGetRequest)({ url: server.url, path, token: server.accessToken, expectedStatus: models_1.HttpStatusCode.FORBIDDEN_403 });
            });
        });
        ...
        it('Should succeed with the correct params', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                yield (0, extra_utils_1.makeGetRequest)({ url: server.url, path, token: userToken, expectedStatus: models_1.HttpStatusCode.OK_200 });
            });
        });
    });
    ...
    describe('When registering a new user', function () {
        ...
        it('Should fail with a too small username', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                const fields = Object.assign(Object.assign({}, baseCorrectParams), { username: '' });
                yield (0, extra_utils_1.makePostBodyRequest)({ url: server.url, path: registrationPath, token: server.accessToken, fields });
            });
        });
        it('Should fail with a too long username', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
