...
describe('Test video comments API validator', function () {
    ...
    describe('When listing video comment threads', function () {
        it('Should fail with a bad start pagination', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                yield (0, extra_utils_1.checkBadStartPagination)(server.url, pathThread, server.accessToken);
            });
        });
        it('Should fail with a bad count pagination', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                yield (0, extra_utils_1.checkBadCountPagination)(server.url, pathThread, server.accessToken);
            });
        });
        it('Should fail with an incorrect sort', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                yield (0, extra_utils_1.checkBadSortPagination)(server.url, pathThread, server.accessToken);
            });
        });
    ...
    describe('When adding a video thread', function () {
        ...
        it('Should fail with nothing', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                const fields = {};
                yield (0, extra_utils_1.makePostBodyRequest)({ url: server.url, path: pathThread, token: server.accessToken, fields });
            });
        });
    ...
    describe('When adding a comment to a thread', function () {
        ...
        it('Should fail with nothing', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                const fields = {};
                yield (0, extra_utils_1.makePostBodyRequest)({ url: server.url, path: pathComment, token: server.accessToken, fields });
            });
        });
        it('Should fail with a short comment', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
    ...
    describe('When removing video comments', function () {
        it('Should fail with a non authenticated user', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                yield (0, extra_utils_1.makeDeleteRequest)({ url: server.url, path: pathComment, token: 'none', expectedStatus: models_1.HttpStatusCode.UNAUTHORIZED_401 });
            });
        });
        ...
        it('Should fail with an incorrect video', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                const path = '/api/v1/videos/ba708d62-e3d7-45d9-9d73-41b9097cc02d/comments/' + commentId;
                yield (0, extra_utils_1.makeDeleteRequest)({ url: server.url, path, token: server.accessToken, expectedStatus: models_1.HttpStatusCode.NOT_FOUND_404 });
            });
        });
        it('Should fail with an incorrect comment', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        it('Should succeed with the same user', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.makeDeleteRequest)({ url: server.url, path, token: userAccessToken2, expectedStatus: models_1.HttpStatusCode.FORBIDDEN_403 });
                yield (0, extra_utils_1.makeDeleteRequest)({ url: server.url, path, token: userAccessToken, expectedStatus: models_1.HttpStatusCode.NO_CONTENT_204 });
            });
        });
