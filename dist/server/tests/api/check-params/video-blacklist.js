...
describe('Test video blacklist API validators', function () {
    ...
    describe('When adding a video in blacklist', function () {
        ...
        it('Should fail with a non authenticated user', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = basePath + servers[0].store.videoCreated + '/blacklist';
                const fields = {};
                yield extra_utils_1.makePostBodyRequest({ url: servers[0].url, path, token: 'hello', fields, expectedStatus: models_1.HttpStatusCode.UNAUTHORIZED_401 });
            });
        });
    ...
    describe('When updating a video in blacklist', function () {
        ...
        it('Should fail with a non authenticated user', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                const path = basePath + servers[0].store.videoCreated + '/blacklist';
                const fields = {};
                yield extra_utils_1.makePutBodyRequest({ url: servers[0].url, path, token: 'hello', fields, expectedStatus: models_1.HttpStatusCode.UNAUTHORIZED_401 });
            });
        });
        it('Should fail with a non admin user', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    describe('When listing videos in blacklist', function () {
        ...
        it('Should fail with a bad start pagination', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.checkBadStartPagination(servers[0].url, basePath, servers[0].accessToken);
            });
        });
        it('Should fail with a bad count pagination', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.checkBadCountPagination(servers[0].url, basePath, servers[0].accessToken);
            });
        });
        it('Should fail with an incorrect sort', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.checkBadSortPagination(servers[0].url, basePath, servers[0].accessToken);
            });
        });
