...
describe('Test admin notifications', function () {
    ...
    before(function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            const res = yield (0, extra_utils_1.prepareNotificationsTest)(1, config);
            emails = res.emails;
    ...
    describe('Latest PeerTube version notification', function () {
        it('Should not send a notification to admins if there is not a new version', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.checkNewPeerTubeVersion)(Object.assign(Object.assign({}, baseParams), { latestVersion: '1.4.2', checkType: 'absence' }));
            });
        });
        it('Should send a notification to admins on new plugin version', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.wait)(3000);
                yield (0, extra_utils_1.checkNewPeerTubeVersion)(Object.assign(Object.assign({}, baseParams), { latestVersion: '15.4.2', checkType: 'presence' }));
            });
        });
        it('Should not send the same notification to admins', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                this.timeout(30000);
                yield (0, extra_utils_1.wait)(3000);
                (0, chai_1.expect)(adminNotifications.filter(n => n.type === 18)).to.have.lengthOf(1);
            });
        });
        it('Should not have sent a notification to users', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                this.timeout(30000);
                (0, chai_1.expect)(userNotifications.filter(n => n.type === 18)).to.have.lengthOf(0);
            });
        });
        it('Should send a new notification after a new release', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.wait)(3000);
                yield (0, extra_utils_1.checkNewPeerTubeVersion)(Object.assign(Object.assign({}, baseParams), { latestVersion: '15.4.3', checkType: 'presence' }));
                (0, chai_1.expect)(adminNotifications.filter(n => n.type === 18)).to.have.lengthOf(2);
            });
        });
    });
    describe('Latest plugin version notification', function () {
        it('Should not send a notification to admins if there is no new plugin version', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.checkNewPluginVersion)(Object.assign(Object.assign({}, baseParams), { pluginType: models_1.PluginType.PLUGIN, pluginName: 'hello-world', checkType: 'absence' }));
            });
        });
        it('Should send a notification to admins on new plugin version', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.wait)(6000);
                yield (0, extra_utils_1.checkNewPluginVersion)(Object.assign(Object.assign({}, baseParams), { pluginType: models_1.PluginType.PLUGIN, pluginName: 'hello-world', checkType: 'presence' }));
            });
        });
        it('Should not send the same notification to admins', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                this.timeout(30000);
                yield (0, extra_utils_1.wait)(6000);
                (0, chai_1.expect)(adminNotifications.filter(n => n.type === 17)).to.have.lengthOf(1);
            });
        });
        it('Should not have sent a notification to users', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                (0, chai_1.expect)(userNotifications.filter(n => n.type === 17)).to.have.lengthOf(0);
            });
        });
