...
describe('Test notifications API', function () {
    ...
    before(function () {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this.timeout(120000);
            const res = yield extra_utils_1.prepareNotificationsTest(1);
            emails = res.emails;
    ...
    describe('Notification settings', function () {
        ...
        it('Should not have notifications', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield server.notifications.updateMySettings({
                    token: userToken,
                    settings: Object.assign(Object.assign({}, extra_utils_1.getAllNotificationsSettings()), { newVideoFromSubscription: 0 })
                });
                {
                ...
                yield extra_utils_1.checkNewVideoFromSubscription(Object.assign(Object.assign({}, baseParams), { check, videoName: name, shortUUID, checkType: 'absence' }));
            });
        });
        it('Should only have web notifications', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield server.notifications.updateMySettings({
                    token: userToken,
                    settings: Object.assign(Object.assign({}, extra_utils_1.getAllNotificationsSettings()), { newVideoFromSubscription: 1 })
                });
                {
                    const info = yield server.users.getMyInfo({ token: userToken });
                ...
                }
                {
                    ...
                    yield extra_utils_1.checkNewVideoFromSubscription(Object.assign(Object.assign({}, baseParams), { check, videoName: name, shortUUID, checkType: 'presence' }));
                }
            });
        });
        it('Should only have mail notifications', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield server.notifications.updateMySettings({
                    token: userToken,
                    settings: Object.assign(Object.assign({}, extra_utils_1.getAllNotificationsSettings()), { newVideoFromSubscription: 2 })
                });
                {
                    const info = yield server.users.getMyInfo({ token: userToken });
        ...
        it('Should have email and web notifications', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield server.notifications.updateMySettings({
                    token: userToken,
                    settings: Object.assign(Object.assign({}, extra_utils_1.getAllNotificationsSettings()), { newVideoFromSubscription: 1 | 2 })
                });
                {
                    const info = yield server.users.getMyInfo({ token: userToken });
