    ...
    describe('Comment on my video notifications', function () {
        ...
        it('Should not send a new comment notification after a comment on another video', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.checkNewCommentOnMyVideo)(Object.assign(Object.assign({}, baseParams), { shortUUID, threadId: commentId, commentId, checkType: 'absence' }));
            });
        });
        ...
        it('Should send a new comment notification after a local comment on my video', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                const commentId = created.id;
                yield (0, extra_utils_1.waitJobs)(servers);
                yield (0, extra_utils_1.checkNewCommentOnMyVideo)(Object.assign(Object.assign({}, baseParams), { shortUUID, threadId: commentId, commentId, checkType: 'presence' }));
            });
        });
        ...
        it('Should send a new comment notification after a local reply on my video', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.waitJobs)(servers);
                yield (0, extra_utils_1.checkNewCommentOnMyVideo)(Object.assign(Object.assign({}, baseParams), { shortUUID, threadId, commentId, checkType: 'presence' }));
            });
        });
    ...
    describe('Mention notifications', function () {
        ...
        it('Should not send a new mention comment notification if I mention the video owner', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.waitJobs)(servers);
                yield (0, extra_utils_1.checkCommentMention)(Object.assign(Object.assign({}, baseParams), { shortUUID, threadId: commentId, commentId, byAccountDisplayName, checkType: 'absence' }));
            });
        });
        ...
        it('Should not send a new mention notification if the remote account mention a local account', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.checkCommentMention)(Object.assign(Object.assign({}, baseParams), { shortUUID, threadId, commentId: threadId, byAccountDisplayName, checkType: 'absence' }));
            });
        });
        it('Should send a new mention notification after local comments', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.waitJobs)(servers);
                yield (0, extra_utils_1.checkCommentMention)(Object.assign(Object.assign({}, baseParams), { shortUUID, threadId, commentId: threadId, byAccountDisplayName, checkType: 'presence' }));
                const { id: commentId } = yield servers[0].comments.addReply({ videoId: uuid, toCommentId: threadId, text: 'hello 2 @user_1' });
                yield (0, extra_utils_1.waitJobs)(servers);
                yield (0, extra_utils_1.checkCommentMention)(Object.assign(Object.assign({}, baseParams), { shortUUID, commentId, threadId, byAccountDisplayName, checkType: 'presence' }));
            });
        });
        it('Should send a new mention notification after remote comments', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                const byAccountDisplayName = 'super root 2 name';
                const threadId = data[0].id;
                yield (0, extra_utils_1.checkCommentMention)(Object.assign(Object.assign({}, baseParams), { shortUUID, commentId: threadId, threadId, byAccountDisplayName, checkType: 'presence' }));
