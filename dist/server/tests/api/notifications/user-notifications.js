...
describe('Test user notifications', function () {
    ...
    describe('New video from my subscription notification', function () {
        ...
        it('Should not send notifications if the user does not follow the video publisher', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                this.timeout(50000);
                yield (0, extra_utils_1.uploadRandomVideoOnServers)(servers, 1);
        ...
        it('Should send a new video notification if the user follows the local video publisher', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                const { name, shortUUID } = yield (0, extra_utils_1.uploadRandomVideoOnServers)(servers, 1);
        ...
        it('Should send a new video notification from a remote account', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.waitJobs)(servers);
                const { name, shortUUID } = yield (0, extra_utils_1.uploadRandomVideoOnServers)(servers, 2);
                yield (0, extra_utils_1.checkNewVideoFromSubscription)(Object.assign(Object.assign({}, baseParams), { videoName: name, shortUUID, checkType: 'presence' }));
            });
        });
        it('Should send a new video notification on a scheduled publication', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                const { name, shortUUID } = yield (0, extra_utils_1.uploadRandomVideoOnServers)(servers, 1, data);
        ...
        it('Should send a new video notification on a remote scheduled publication', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                const { name, shortUUID } = yield (0, extra_utils_1.uploadRandomVideoOnServers)(servers, 2, data);
                yield (0, extra_utils_1.waitJobs)(servers);
                yield (0, extra_utils_1.wait)(6000);
                yield (0, extra_utils_1.checkNewVideoFromSubscription)(Object.assign(Object.assign({}, baseParams), { videoName: name, shortUUID, checkType: 'presence' }));
            });
        ...
        it('Should not send a notification before the video is published', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                const { name, shortUUID } = yield (0, extra_utils_1.uploadRandomVideoOnServers)(servers, 1, data);
                yield (0, extra_utils_1.wait)(6000);
                yield (0, extra_utils_1.checkNewVideoFromSubscription)(Object.assign(Object.assign({}, baseParams), { videoName: name, shortUUID, checkType: 'absence' }));
            });
        });
        it('Should send a new video notification when a video becomes public', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                const { name, uuid, shortUUID } = yield (0, extra_utils_1.uploadRandomVideoOnServers)(servers, 1, data);
                yield (0, extra_utils_1.checkNewVideoFromSubscription)(Object.assign(Object.assign({}, baseParams), { videoName: name, shortUUID, checkType: 'absence' }));
        ...
        it('Should send a new video notification when a remote video becomes public', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                this.timeout(50000);
                const data = { privacy: 3 };
                const { name, uuid, shortUUID } = yield (0, extra_utils_1.uploadRandomVideoOnServers)(servers, 2, data);
                yield (0, extra_utils_1.checkNewVideoFromSubscription)(Object.assign(Object.assign({}, baseParams), { videoName: name, shortUUID, checkType: 'absence' }));
        ...
        it('Should send a new video notification after a video import', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                this.timeout(100000);
                const name = 'video import ' + (0, uuid_1.buildUUID)();
                const attributes = {
                    name,
                    channelId,
                    privacy: 1,
                ...
                yield (0, extra_utils_1.waitJobs)(servers);
                yield (0, extra_utils_1.checkNewVideoFromSubscription)(Object.assign(Object.assign({}, baseParams), { videoName: name, shortUUID: video.shortUUID, checkType: 'presence' }));
            });
        });
    });
    describe('My video is published', function () {
        ...
        it('Should not send a notification if transcoding is not enabled', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                const { name, shortUUID } = yield (0, extra_utils_1.uploadRandomVideoOnServers)(servers, 1);
                yield (0, extra_utils_1.waitJobs)(servers);
                yield (0, extra_utils_1.checkVideoIsPublished)(Object.assign(Object.assign({}, baseParams), { videoName: name, shortUUID, checkType: 'absence' }));
            });
        });
        it('Should not send a notification if the wait transcoding is false', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                this.timeout(50000);
                yield (0, extra_utils_1.uploadRandomVideoOnServers)(servers, 2, { waitTranscoding: false });
                yield (0, extra_utils_1.waitJobs)(servers);
                const notification = yield servers[0].notifications.getLastest({ token: userAccessToken });
                if (notification) {
        ...
        it('Should send a notification even if the video is not transcoded in other resolutions', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                this.timeout(50000);
                const { name, shortUUID } = yield (0, extra_utils_1.uploadRandomVideoOnServers)(servers, 2, { waitTranscoding: true, fixture: 'video_short_240p.mp4' });
                yield (0, extra_utils_1.waitJobs)(servers);
                yield (0, extra_utils_1.checkVideoIsPublished)(Object.assign(Object.assign({}, baseParams), { videoName: name, shortUUID, checkType: 'presence' }));
            });
        });
        it('Should send a notification with a transcoded video', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                this.timeout(50000);
                const { name, shortUUID } = yield (0, extra_utils_1.uploadRandomVideoOnServers)(servers, 2, { waitTranscoding: true });
                yield (0, extra_utils_1.waitJobs)(servers);
                yield (0, extra_utils_1.checkVideoIsPublished)(Object.assign(Object.assign({}, baseParams), { videoName: name, shortUUID, checkType: 'presence' }));
            });
        });
        it('Should send a notification when an imported video is transcoded', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.waitJobs)(servers);
                yield (0, extra_utils_1.checkVideoIsPublished)(Object.assign(Object.assign({}, baseParams), { videoName: name, shortUUID: video.shortUUID, checkType: 'presence' }));
            });
        });
    ...
    describe('My video is imported', function () {
        ...
        it('Should send a notification when the video import failed', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.checkMyVideoImportIsFinished)(Object.assign(Object.assign({}, baseParams), { videoName: name, shortUUID, url, success: false, checkType: 'presence' }));
            });
        });
        it('Should send a notification when the video import succeeded', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.checkMyVideoImportIsFinished)(Object.assign(Object.assign({}, baseParams), { videoName: name, shortUUID, url, success: true, checkType: 'presence' }));
            });
        });
    });
    describe('New actor follow', function () {
        ...
        it('Should notify when a local channel is following one of our channel', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.waitJobs)(servers);
                yield (0, extra_utils_1.checkNewActorFollow)(Object.assign(Object.assign({}, baseParams), { followType: 'channel', followerName: 'root', followerDisplayName: 'super root name', followingDisplayName: myChannelName, checkType: 'presence' }));
        ...
        it('Should notify when a remote channel is following one of our channel', function () {
            return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield (0, extra_utils_1.waitJobs)(servers);
                yield (0, extra_utils_1.checkNewActorFollow)(Object.assign(Object.assign({}, baseParams), { followType: 'channel', followerName: 'root', followerDisplayName: 'super root 2 name', followingDisplayName: myChannelName, checkType: 'presence' }));
