...
describe('Test moderation notifications', function () {
    ...
    describe('Abuse for moderators notification', function () {
        ...
        it('Should send a notification to moderators on local video abuse', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                this.timeout(20000);
                const name = 'video for abuse ' + uuid_1.buildUUID();
                ...
                yield extra_utils_1.checkNewVideoAbuseForModerators(Object.assign(Object.assign({}, baseParams), { shortUUID: video.shortUUID, videoName: name, checkType: 'presence' }));
            });
        });
        ...
        it('Should send a notification to moderators on local comment abuse', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const comment = yield servers[0].comments.createThread({
                    ...
                    videoId: video.id,
                    text: 'comment abuse ' + uuid_1.buildUUID()
                });
                yield extra_utils_1.waitJobs(servers);
                yield servers[0].abuses.report({ commentId: comment.id, reason: 'super reason' });
                yield extra_utils_1.waitJobs(servers);
                yield extra_utils_1.checkNewCommentAbuseForModerators(Object.assign(Object.assign({}, baseParams), { shortUUID: video.shortUUID, videoName: name, checkType: 'presence' }));
            });
        });
        ...
        it('Should send a notification to moderators on local account abuse', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield extra_utils_1.waitJobs(servers);
                yield extra_utils_1.checkNewAccountAbuseForModerators(Object.assign(Object.assign({}, baseParams), { displayName: username, checkType: 'presence' }));
            });
        });
    ...
    describe('Abuse state change notification', function () {
        ...
        before(function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const name = 'abuse ' + uuid_1.buildUUID();
                const video = yield servers[0].videos.upload({ token: userAccessToken, attributes: { name } });
        ...
        it('Should send a notification to reporter if the abuse has been accepted', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield extra_utils_1.waitJobs(servers);
                yield extra_utils_1.checkAbuseStateChange(Object.assign(Object.assign({}, baseParams), { abuseId, state: 3, checkType: 'presence' }));
            });
        });
        it('Should send a notification to reporter if the abuse has been rejected', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield extra_utils_1.waitJobs(servers);
                yield extra_utils_1.checkAbuseStateChange(Object.assign(Object.assign({}, baseParams), { abuseId, state: 2, checkType: 'presence' }));
            });
        });
    });
    describe('New abuse message notification', function () {
        ...
        it('Should send a notification to reporter on new message', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield extra_utils_1.waitJobs(servers);
                yield extra_utils_1.checkNewAbuseMessage(Object.assign(Object.assign({}, baseParamsUser), { abuseId, message, toEmail: 'user_1@example.com', checkType: 'presence' }));
            });
        });
        it('Should not send a notification to the admin if sent by the admin', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield extra_utils_1.checkNewAbuseMessage(Object.assign(Object.assign({}, baseParamsAdmin), { abuseId, message, toEmail, checkType: 'absence' }));
            });
        });
        it('Should send a notification to moderators', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield extra_utils_1.waitJobs(servers);
                const toEmail = 'admin' + servers[0].internalServerNumber + '@example.com';
                yield extra_utils_1.checkNewAbuseMessage(Object.assign(Object.assign({}, baseParamsAdmin), { abuseId: abuseId2, message, toEmail, checkType: 'presence' }));
            });
        });
        it('Should not send a notification to reporter if sent by the reporter', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield extra_utils_1.checkNewAbuseMessage(Object.assign(Object.assign({}, baseParamsUser), { abuseId: abuseId2, message, toEmail, checkType: 'absence' }));
            });
        });
    });
    describe('Video blacklist on my video', function () {
        ...
        it('Should send a notification to video owner on blacklist', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield extra_utils_1.waitJobs(servers);
                yield extra_utils_1.checkNewBlacklistOnMyVideo(Object.assign(Object.assign({}, baseParams), { shortUUID, videoName: name, blacklistType: 'blacklist' }));
            });
        });
        it('Should send a notification to video owner on unblacklist', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield extra_utils_1.checkNewBlacklistOnMyVideo(Object.assign(Object.assign({}, baseParams), { shortUUID, videoName: name, blacklistType: 'unblacklist' }));
            });
        });
    });
    describe('New registration', function () {
        ...
        it('Should send a notification only to moderators when a user registers on the instance', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield extra_utils_1.waitJobs(servers);
                yield extra_utils_1.checkUserRegistered(Object.assign(Object.assign({}, baseParams), { username: 'user_45', checkType: 'presence' }));
                const userOverride = { socketNotifications: userNotifications, token: userAccessToken, check: { web: true, mail: false } };
                yield extra_utils_1.checkUserRegistered(Object.assign(Object.assign(Object.assign({}, baseParams), userOverride), { username: 'user_45', checkType: 'absence' }));
            });
        });
    });
    describe('New instance follows', function () {
        ...
        it('Should send a notification only to admin when there is a new instance follower', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield extra_utils_1.waitJobs(servers);
                yield extra_utils_1.checkNewInstanceFollower(Object.assign(Object.assign({}, baseParams), { followerHost: 'localhost:' + servers[2].port, checkType: 'presence' }));
                const userOverride = { socketNotifications: userNotifications, token: userAccessToken, check: { web: true, mail: false } };
                yield extra_utils_1.checkNewInstanceFollower(Object.assign(Object.assign(Object.assign({}, baseParams), userOverride), { followerHost: 'localhost:' + servers[2].port, checkType: 'absence' }));
            });
        });
        it('Should send a notification on auto follow back', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                yield extra_utils_1.checkAutoInstanceFollowing(Object.assign(Object.assign({}, baseParams), { followerHost, followingHost, checkType: 'presence' }));
                const userOverride = { socketNotifications: userNotifications, token: userAccessToken, check: { web: true, mail: false } };
                yield extra_utils_1.checkAutoInstanceFollowing(Object.assign(Object.assign(Object.assign({}, baseParams), userOverride), { followerHost, followingHost, checkType: 'absence' }));
    ...
    describe('Video-related notifications when video auto-blacklist is enabled', function () {
        ...
        it('Should send notification to moderators on new video with auto-blacklist', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                this.timeout(40000);
                videoName = 'video with auto-blacklist ' + uuid_1.buildUUID();
                const video = yield servers[0].videos.upload({ token: userAccessToken, attributes: { name: videoName } });
                shortUUID = video.shortUUID;
                uuid = video.uuid;
                yield extra_utils_1.waitJobs(servers);
                yield extra_utils_1.checkVideoAutoBlacklistForModerators(Object.assign(Object.assign({}, adminBaseParamsServer1), { shortUUID, videoName, checkType: 'presence' }));
            });
        });
        it('Should not send video publish notification if auto-blacklisted', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.checkVideoIsPublished(Object.assign(Object.assign({}, userBaseParams), { videoName, shortUUID, checkType: 'absence' }));
            });
        });
        it('Should not send a local user subscription notification if auto-blacklisted', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.checkNewVideoFromSubscription(Object.assign(Object.assign({}, adminBaseParamsServer1), { videoName, shortUUID, checkType: 'absence' }));
            });
        });
        it('Should not send a remote user subscription notification if auto-blacklisted', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.checkNewVideoFromSubscription(Object.assign(Object.assign({}, adminBaseParamsServer2), { videoName, shortUUID, checkType: 'absence' }));
            });
        });
        ...
        it('Should send a local user subscription notification after removed from blacklist', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.checkNewVideoFromSubscription(Object.assign(Object.assign({}, adminBaseParamsServer1), { videoName, shortUUID, checkType: 'presence' }));
            });
        });
        it('Should send a remote user subscription notification after removed from blacklist', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield extra_utils_1.checkNewVideoFromSubscription(Object.assign(Object.assign({}, adminBaseParamsServer2), { videoName, shortUUID, checkType: 'presence' }));
            });
        });
        it('Should send unblacklist but not published/subscription notes after unblacklisted if scheduled update pending', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const name = 'video with auto-blacklist and future schedule ' + uuid_1.buildUUID();
                const attributes = {
                    name,
                    privacy: 3,
                    scheduleUpdate: {
                ...
                yield servers[0].blacklist.remove({ videoId: uuid });
                yield extra_utils_1.waitJobs(servers);
                yield extra_utils_1.checkNewBlacklistOnMyVideo(Object.assign(Object.assign({}, userBaseParams), { shortUUID, videoName: name, blacklistType: 'unblacklist' }));
                yield extra_utils_1.checkNewVideoFromSubscription(Object.assign(Object.assign({}, adminBaseParamsServer1), { videoName: name, shortUUID, checkType: 'absence' }));
                yield extra_utils_1.checkNewVideoFromSubscription(Object.assign(Object.assign({}, adminBaseParamsServer2), { videoName: name, shortUUID, checkType: 'absence' }));
            });
        });
        it('Should not send publish/subscription notifications after scheduled update if video still auto-blacklisted', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const name = 'video with schedule done and still auto-blacklisted ' + uuid_1.buildUUID();
                const attributes = {
                    name,
                    privacy: 3,
                    scheduleUpdate: {
                ...
                yield extra_utils_1.checkVideoIsPublished(Object.assign(Object.assign({}, userBaseParams), { videoName: name, shortUUID, checkType: 'absence' }));
                yield extra_utils_1.checkNewVideoFromSubscription(Object.assign(Object.assign({}, adminBaseParamsServer1), { videoName: name, shortUUID, checkType: 'absence' }));
                yield extra_utils_1.checkNewVideoFromSubscription(Object.assign(Object.assign({}, adminBaseParamsServer2), { videoName: name, shortUUID, checkType: 'absence' }));
            });
        });
        it('Should not send a notification to moderators on new video without auto-blacklist', function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                this.timeout(60000);
                const name = 'video without auto-blacklist ' + uuid_1.buildUUID();
                const { shortUUID } = yield servers[0].videos.upload({ attributes: { name } });
                yield extra_utils_1.waitJobs(servers);
                yield extra_utils_1.checkVideoAutoBlacklistForModerators(Object.assign(Object.assign({}, adminBaseParamsServer1), { shortUUID, videoName: name, checkType: 'absence' }));
            });
        });
