...
describe('Parse Bytes', function () {
    it('Should pass when given valid value', function () {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            expect(core_utils_2.parseBytes(1024)).to.be.eq(1024);
            expect(core_utils_2.parseBytes(1048576)).to.be.eq(1048576);
            expect(core_utils_2.parseBytes('1024')).to.be.eq(1024);
            expect(core_utils_2.parseBytes('1048576')).to.be.eq(1048576);
            expect(core_utils_2.parseBytes('1B')).to.be.eq(1024);
            expect(core_utils_2.parseBytes('1MB')).to.be.eq(1048576);
            expect(core_utils_2.parseBytes('1GB')).to.be.eq(1073741824);
            expect(core_utils_2.parseBytes('1TB')).to.be.eq(1099511627776);
            expect(core_utils_2.parseBytes('5GB')).to.be.eq(5368709120);
            expect(core_utils_2.parseBytes('5TB')).to.be.eq(5497558138880);
            expect(core_utils_2.parseBytes('1024B')).to.be.eq(1048576);
            expect(core_utils_2.parseBytes('1024MB')).to.be.eq(1073741824);
            expect(core_utils_2.parseBytes('1024GB')).to.be.eq(1099511627776);
            expect(core_utils_2.parseBytes('1024TB')).to.be.eq(1125899906842624);
            expect(core_utils_2.parseBytes('1 GB')).to.be.eq(1073741824);
            expect(core_utils_2.parseBytes('1\tGB')).to.be.eq(1073741824);
            expect(core_utils_2.parseBytes('1TB 1024MB')).to.be.eq(1100585369600);
            expect(core_utils_2.parseBytes('4GB 1024MB')).to.be.eq(5368709120);
            expect(core_utils_2.parseBytes('4TB 1024GB')).to.be.eq(5497558138880);
            expect(core_utils_2.parseBytes('4TB 1024GB 0MB')).to.be.eq(5497558138880);
            expect(core_utils_2.parseBytes('1024TB 1024GB 1024MB')).to.be.eq(1127000492212224);
        });
    });
    it('Should be invalid when given invalid value', function () {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            expect(core_utils_2.parseBytes('6GB 1GB')).to.be.eq(6);
        });
    });
});
describe('Object', function () {
    it('Should convert an object', function () {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const res = core_utils_2.objectConverter(obj, keyConverter, valueConverter);
...
describe('Bitrate', function () {
    it('Should get appropriate max bitrate', function () {
        ...
        for (const test of tests) {
            expect(core_utils_1.getMaxBitrate(test)).to.be.above(test.min * 1000).and.below(test.max * 1000);
        }
    });
    it('Should get appropriate average bitrate', function () {
        ...
        for (const test of tests) {
            expect(core_utils_1.getAverageBitrate(test)).to.be.above(test.min * 1000).and.below(test.max * 1000);
        }
    });
});
