...
describe('Test print transcode jobs', function () {
    it('Should print the correct command for each resolution', function () {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const fixturePath = extra_utils_1.buildAbsoluteFixturePath('video_short.webm');
            ...
            for (const resolution of [
                ...
                const targetBitrate = Math.min(core_utils_1.getMaxBitrate({ resolution, fps, ratio: 16 / 9 }), bitrate + (bitrate * 0.3));
