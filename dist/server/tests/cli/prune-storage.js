...
function countFiles(server, directory) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const files = yield fs_extra_1.readdir(server.servers.buildDirectory(directory));
        return files.length;
    });
}
...
describe('Test prune storage scripts', function () {
    ...
    before(function () {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this.timeout(120000);
            servers = yield extra_utils_1.createMultipleServers(2, { transcoding: { enabled: true } });
            ...
            for (let i = 0; i < 2; i++) {
                {
                    ...
                    const n1 = uuid_1.buildUUID() + '.mp4';
                    const n2 = uuid_1.buildUUID() + '.webm';
                ...
                }
                {
                    ...
                    const n1 = uuid_1.buildUUID() + '-240.torrent';
                    const n2 = uuid_1.buildUUID() + '-480.torrent';
                    yield fs_extra_1.createFile(path_1.join(base, n1));
                    yield fs_extra_1.createFile(path_1.join(base, n2));
                ...
                }
                {
                    ...
                    const n1 = uuid_1.buildUUID() + '.jpg';
                    const n2 = uuid_1.buildUUID() + '.jpg';
                    yield fs_extra_1.createFile(path_1.join(base, n1));
                    yield fs_extra_1.createFile(path_1.join(base, n2));
