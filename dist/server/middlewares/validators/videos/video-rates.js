...
const videoUpdateRateValidator = [
    ...
    (0, express_validator_1.body)('rating').custom(videos_1.isVideoRatingTypeValid).withMessage('Should have a valid rate type'),
...
const getAccountVideoRateValidatorFactory = function (rateType) {
    return [
        ...
        (0, express_validator_1.param)('videoId').custom(misc_1.isIdValid).not().isEmpty().withMessage('Should have a valid videoId'),
        (req, res, next) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
...
const videoRatingValidator = [
    (0, express_validator_1.query)('rating').optional().custom(video_rates_1.isRatingValid).withMessage('Value must be one of "like" or "dislike"'),
    (req, res, next) => {
