...
const removeFollowingValidator = [
    express_validator_1.param('hostOrHandle')
        .custom(value => servers_1.isHostValid(value) || follows_1.isRemoteHandleValid(value))
    ...
    (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const { name, host } = follow_1.getRemoteNameAndHost(req.params.hostOrHandle);
...
const getFollowerValidator = [
    express_validator_1.param('nameWithHost').custom(actor_1.isValidActorHandle).withMessage('Should have a valid nameWithHost'),
    (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        let follow;
        try {
            const actorUrl = yield actors_1.loadActorUrlOrGetFromWebfinger(req.params.nameWithHost);
