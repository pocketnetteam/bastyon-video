...
const srt_to_vtt_1 = (0, tslib_1.__importDefault)(require("srt-to-vtt"));
...
function moveAndProcessCaptionFile(physicalFile, videoCaption) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const destination = (0, path_1.join)(videoCaptionsDir, videoCaption.filename);
        if (physicalFile.path.endsWith('.srt')) {
            yield convertSrtToVtt(physicalFile.path, destination);
            yield (0, fs_extra_1.remove)(physicalFile.path);
        }
        else if (physicalFile.path !== destination) {
            yield (0, fs_extra_1.move)(physicalFile.path, destination, { overwrite: true });
        }
...
function convertSrtToVtt(source, destination) {
    ...
    return (0, core_utils_1.pipelinePromise)((0, fs_extra_1.createReadStream)(source), (0, srt_to_vtt_1.default)(), fixVTT, (0, fs_extra_1.createWriteStream)(destination));
}
