...
const toInt_1 = tslib_1.__importDefault(require("validator/lib/toInt"));
...
videosRouter.get('/categories', doc_1.openapiOperationDoc({ operationId: 'getCategories' }), listVideoCategories);
videosRouter.get('/licences', doc_1.openapiOperationDoc({ operationId: 'getLicences' }), listVideoLicences);
videosRouter.get('/languages', doc_1.openapiOperationDoc({ operationId: 'getLanguages' }), listVideoLanguages);
videosRouter.get('/privacies', doc_1.openapiOperationDoc({ operationId: 'getPrivacies' }), listVideoPrivacies);
videosRouter.get('/', doc_1.openapiOperationDoc({ operationId: 'getVideos' }), middlewares_1.paginationValidator, middlewares_1.videosSortValidator, middlewares_1.setDefaultVideosSort, middlewares_1.setDefaultPagination, middlewares_1.optionalAuthenticate, middlewares_1.commonVideosFiltersValidator, middlewares_1.asyncMiddleware(listVideos));
videosRouter.get('/:id/description', doc_1.openapiOperationDoc({ operationId: 'getVideoDesc' }), middlewares_1.asyncMiddleware(middlewares_1.videosGetValidator), middlewares_1.asyncMiddleware(getVideoDescription));
...
videosRouter.get('/:id', doc_1.openapiOperationDoc({ operationId: 'getVideo' }), middlewares_1.optionalAuthenticate, middlewares_1.asyncMiddleware(middlewares_1.videosCustomGetValidator('for-api')), middlewares_1.asyncMiddleware(middlewares_1.checkVideoFollowConstraints), getVideo);
videosRouter.post('/:id/views', doc_1.openapiOperationDoc({ operationId: 'addView' }), middlewares_1.asyncMiddleware(middlewares_1.videosCustomGetValidator('only-immutable-attributes')), middlewares_1.asyncMiddleware(viewVideo));
videosRouter.delete('/:id', doc_1.openapiOperationDoc({ operationId: 'delVideo' }), middlewares_1.authenticate, middlewares_1.asyncMiddleware(middlewares_1.videosRemoveValidator), middlewares_1.asyncRetryTransactionMiddleware(removeVideo));
...
function listVideos(req, res) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const apiOptions = yield hooks_1.Hooks.wrapObject(Object.assign(Object.assign({}, query), { includeLocalVideos: true, nsfw: express_utils_1.buildNSFWFilter(res, query.nsfw), withFiles: false, user: res.locals.oauth ? res.locals.oauth.token.User : undefined, countVideos }), 'filter:api.videos.list.params');
...
function fetchRemoteVideoDescription(video) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const { body } = yield requests_1.doJSONRequest(url);
