...
liveRouter.get('/live/:videoId', middlewares_1.authenticate, middlewares_1.asyncMiddleware(video_live_1.videoLiveGetValidator), getLiveVideo);
...
function addLiveVideo(req, res) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        videoLive.streamKey = uuid_1.buildUUID();
