...
bulkRouter.post('/remove-comments-of', middlewares_1.authenticate, (0, middlewares_1.asyncMiddleware)(bulk_1.bulkRemoveCommentsOfValidator), (0, middlewares_1.asyncMiddleware)(bulkRemoveCommentsOf));
function bulkRemoveCommentsOf(req, res) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        for (const comment of comments) {
            yield (0, video_comment_1.removeComment)(comment);
        }
    });
}
