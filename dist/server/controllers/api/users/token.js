...
const loginRateLimiter = express_rate_limit_1.default({
    windowMs: config_1.CONFIG.RATES_LIMIT.LOGIN.WINDOW_MS,
    max: config_1.CONFIG.RATES_LIMIT.LOGIN.MAX
});
tokensRouter.post('/token', loginRateLimiter, middlewares_1.openapiOperationDoc({ operationId: 'getOAuthToken' }), middlewares_1.asyncMiddleware(handleToken));
tokensRouter.post('/revoke-token', middlewares_1.openapiOperationDoc({ operationId: 'revokeOAuthToken' }), middlewares_1.authenticate, middlewares_1.asyncMiddleware(handleTokenRevocation));
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const refreshTokenAuthName = grantType === 'refresh_token'
                ? yield external_auth_1.getAuthNameFromRefreshGrant(req.body.refresh_token)
                : undefined;
            const options = {
                refreshTokenAuthName,
                bypassLogin
            };
            const token = yield oauth_1.handleOAuthToken(req, options);
...
function handleTokenRevocation(req, res) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield oauth_model_1.revokeToken(token, { req, explicitLogout: true });
...
function renewScopedTokens(req, res) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const user = res.locals.oauth.token.user;
        user.feedToken = uuid_1.buildUUID();
        yield user.save();
        return res.json({
            feedToken: user.feedToken
        });
...
function buildByPassLogin(req, grantType) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (req.body.externalAuthToken) {
            return external_auth_1.getBypassFromExternalAuth(req.body.username, req.body.externalAuthToken);
        }
        return external_auth_1.getBypassFromPasswordGrant(req.body.username, req.body.password);
    });
}
