...
serverRedundancyRouter.put('/redundancy/:host', middlewares_1.authenticate, middlewares_1.ensureUserHasRight(2), middlewares_1.asyncMiddleware(redundancy_2.updateServerRedundancyValidator), middlewares_1.asyncMiddleware(updateRedundancy));
serverRedundancyRouter.get('/redundancy/videos', middlewares_1.authenticate, middlewares_1.ensureUserHasRight(24), redundancy_2.listVideoRedundanciesValidator, middlewares_1.paginationValidator, middlewares_1.videoRedundanciesSortValidator, middlewares_1.setDefaultVideoRedundanciesSort, middlewares_1.setDefaultPagination, middlewares_1.asyncMiddleware(listVideoRedundancies));
serverRedundancyRouter.post('/redundancy/videos', middlewares_1.authenticate, middlewares_1.ensureUserHasRight(24), redundancy_2.addVideoRedundancyValidator, middlewares_1.asyncMiddleware(addVideoRedundancy));
serverRedundancyRouter.delete('/redundancy/videos/:redundancyId', middlewares_1.authenticate, middlewares_1.ensureUserHasRight(24), redundancy_2.removeVideoRedundancyValidator, middlewares_1.asyncMiddleware(removeVideoRedundancyController));
...
function removeVideoRedundancyController(req, res) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        yield redundancy_1.removeVideoRedundancy(res.locals.videoRedundancy);
        return res.status(http_error_codes_1.HttpStatusCode.NO_CONTENT_204).end();
    });
}
