...
logsRouter.get('/logs', middlewares_1.authenticate, middlewares_1.ensureUserHasRight(3), logs_1.getLogsValidator, middlewares_1.asyncMiddleware(getLogs));
logsRouter.get('/audit-logs', middlewares_1.authenticate, middlewares_1.ensureUserHasRight(3), logs_1.getAuditLogsValidator, middlewares_1.asyncMiddleware(getAuditLogs));
...
function generateOutput(options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const sortedLogFiles = yield logger_1.mtimeSortFilesDesc(logFiles, config_1.CONFIG.STORAGE.LOG_DIR);
        let currentSize = 0;
