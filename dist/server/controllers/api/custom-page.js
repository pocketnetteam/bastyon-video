...
customPageRouter.get('/homepage/instance', middlewares_1.asyncMiddleware(getInstanceHomepage));
customPageRouter.put('/homepage/instance', middlewares_1.authenticate, middlewares_1.ensureUserHasRight(9), middlewares_1.asyncMiddleware(updateInstanceHomepage));
