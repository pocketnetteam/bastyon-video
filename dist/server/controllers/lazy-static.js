...
lazyStaticRouter.use((0, cors_1.default)());
lazyStaticRouter.use(constants_1.LAZY_STATIC_PATHS.AVATARS + ':filename', (0, middlewares_1.asyncMiddleware)(getActorImage));
lazyStaticRouter.use(constants_1.LAZY_STATIC_PATHS.BANNERS + ':filename', (0, middlewares_1.asyncMiddleware)(getActorImage));
lazyStaticRouter.use(constants_1.LAZY_STATIC_PATHS.PREVIEWS + ':filename', (0, middlewares_1.asyncMiddleware)(getPreview));
lazyStaticRouter.use(constants_1.LAZY_STATIC_PATHS.VIDEO_CAPTIONS + ':filename', (0, middlewares_1.asyncMiddleware)(getVideoCaption));
lazyStaticRouter.use(constants_1.LAZY_STATIC_PATHS.TORRENTS + ':filename', (0, middlewares_1.asyncMiddleware)(getTorrent));
function getActorImage(req, res, next) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        if (image.onDisk === false) {
            ...
            try {
                yield (0, local_actor_1.pushActorImageProcessInQueue)({ filename: image.filename, fileUrl: image.fileUrl, type: image.type });
            }
            catch (err) {
