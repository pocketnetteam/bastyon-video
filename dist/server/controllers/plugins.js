...
const sendFileOptions = {
    maxAge: '30 days',
    immutable: !(0, core_utils_1.isTestInstance)()
};
...
pluginsRouter.get('/plugins/:pluginName/:pluginVersion/auth/:authName', (0, plugins_1.getPluginValidator)(plugin_type_1.PluginType.PLUGIN), plugins_1.getExternalAuthValidator, handleAuthInPlugin);
pluginsRouter.get('/plugins/:pluginName/:pluginVersion/static/:staticEndpoint(*)', (0, plugins_1.getPluginValidator)(plugin_type_1.PluginType.PLUGIN), plugins_1.pluginStaticDirectoryValidator, servePluginStaticDirectory);
pluginsRouter.get('/plugins/:pluginName/:pluginVersion/client-scripts/:staticEndpoint(*)', (0, plugins_1.getPluginValidator)(plugin_type_1.PluginType.PLUGIN), plugins_1.pluginStaticDirectoryValidator, servePluginClientScripts);
pluginsRouter.use('/plugins/:pluginName/router', (0, plugins_1.getPluginValidator)(plugin_type_1.PluginType.PLUGIN, false), auth_1.optionalAuthenticate, servePluginCustomRoutes);
pluginsRouter.use('/plugins/:pluginName/:pluginVersion/router', (0, plugins_1.getPluginValidator)(plugin_type_1.PluginType.PLUGIN), auth_1.optionalAuthenticate, servePluginCustomRoutes);
pluginsRouter.get('/themes/:pluginName/:pluginVersion/static/:staticEndpoint(*)', (0, plugins_1.getPluginValidator)(plugin_type_1.PluginType.THEME), plugins_1.pluginStaticDirectoryValidator, servePluginStaticDirectory);
pluginsRouter.get('/themes/:pluginName/:pluginVersion/client-scripts/:staticEndpoint(*)', (0, plugins_1.getPluginValidator)(plugin_type_1.PluginType.THEME), plugins_1.pluginStaticDirectoryValidator, servePluginClientScripts);
...
function getPluginTranslations(req, res) {
    ...
    if ((0, i18n_1.is18nLocale)(locale)) {
...
function servePluginStaticDirectory(req, res) {
    ...
    return res.sendFile((0, path_1.join)(plugin.path, staticPath, filepath), sendFileOptions);
}
...
function servePluginClientScripts(req, res) {
    ...
    if (!file)
        return res.status(http_error_codes_1.HttpStatusCode.NOT_FOUND_404).end();
    return res.sendFile((0, path_1.join)(plugin.path, staticEndpoint), sendFileOptions);
}
