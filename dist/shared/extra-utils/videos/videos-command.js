...
class VideosCommand extends shared_1.AbstractCommand {
    ...
    getFileMetadata(options) {
        return (0, requests_1.unwrapBody)(this.getRawRequest(Object.assign(Object.assign({}, options), { url: options.url, implicitToken: false, defaultExpectedStatus: models_1.HttpStatusCode.OK_200 })));
    }
    view(options) {
    ...
    listMyVideos(options = {}) {
        ...
        return this.getRequestBody(Object.assign(Object.assign({}, options), { path, query: (0, core_utils_1.pick)(options, ['start', 'count', 'sort', 'search', 'isLive']), implicitToken: true, defaultExpectedStatus: models_1.HttpStatusCode.OK_200 }));
    }
    list(options = {}) {
    ...
    remove(options) {
        const path = '/api/v1/videos/' + options.id;
        return (0, requests_1.unwrapBody)(this.deleteRequest(Object.assign(Object.assign({}, options), { path, implicitToken: true, defaultExpectedStatus: models_1.HttpStatusCode.NO_CONTENT_204 })));
    }
    removeAll() {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
    ...
    buildLegacyUpload(options) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            return (0, requests_1.unwrapBody)(this.postUploadRequest(Object.assign(Object.assign({}, options), { path, fields: this.buildUploadFields(options.attributes), attaches: this.buildUploadAttaches(options.attributes), implicitToken: true, defaultExpectedStatus: models_1.HttpStatusCode.OK_200 }))).then(body => body.video || body);
        });
    }
    buildResumeUpload(options) {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (attributes.fixture) {
                videoFilePath = (0, miscs_1.buildAbsoluteFixturePath)(attributes.fixture);
                size = (yield (0, fs_extra_1.stat)(videoFilePath)).size;
            ...
            if (videoFilePath && initStatus === models_1.HttpStatusCode.CREATED_201) {
                ...
                (0, chai_1.expect)(locationHeader).to.not.be.undefined;
            ...
            const expectedInitStatus = expectedStatus === models_1.HttpStatusCode.OK_200
                ...
                : expectedStatus;
            (0, chai_1.expect)(initStatus).to.equal(expectedInitStatus);
    ...
    prepareResumableUpload(options) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            return this.postUploadRequest(Object.assign(Object.assign({}, options), { path, headers: {
                ...
                }, fields: Object.assign({ filename: attributes.fixture }, this.buildUploadFields(options.attributes)), attaches: this.buildUploadAttaches((0, lodash_1.omit)(options.attributes, 'fixture')), implicitToken: true, defaultExpectedStatus: null }));
        });
    }
    sendResumableChunks(options) {
        ...
        const readable = (0, fs_extra_1.createReadStream)(videoFilePath, { highWaterMark: 8 * 1024 });
        return new Promise((resolve, reject) => {
            readable.on('data', function onData(chunk) {
                return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    const res = yield (0, got_1.default)({
                        url,
                        method: 'put',
                        headers,
    ...
    randomUpload(options = {}) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            const name = prefixName + (0, uuid_1.buildUUID)();
            ...
            if (wait)
                yield (0, server_1.waitJobs)([this.server]);
            return Object.assign(Object.assign({}, result), { name });
        });
    }
    buildListQuery(options) {
        return (0, core_utils_1.pick)(options, [
            'start',
            'count',
            'sort',
            'nsfw',
    ...
    buildUploadFields(attributes) {
        return (0, lodash_1.omit)(attributes, ['fixture', 'thumbnailfile', 'previewfile']);
    }
    buildUploadAttaches(attributes) {
        const attaches = {};
        for (const key of ['thumbnailfile', 'previewfile']) {
            if (attributes[key])
                attaches[key] = (0, miscs_1.buildAbsoluteFixturePath)(attributes[key]);
        }
        if (attributes.fixture)
            attaches.videofile = (0, miscs_1.buildAbsoluteFixturePath)(attributes.fixture);
        return attaches;
    }
}
