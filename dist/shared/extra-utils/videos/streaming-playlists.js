...
function checkSegmentHash(options) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const videoName = (0, path_1.basename)(file.fileUrl);
        const playlist = yield command.get({ url: `${baseUrlPlaylist}/${(0, core_utils_2.removeFragmentedMP4Ext)(videoName)}.m3u8` });
        ...
        (0, chai_1.expect)((0, core_utils_1.sha256)(segmentBody)).to.equal(shaBody[videoName][range]);
    });
}
...
function checkLiveSegmentHash(options) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const shaBody = yield command.getSegmentSha256({ url: hlsPlaylist.segmentsSha256Url });
        (0, chai_1.expect)((0, core_utils_1.sha256)(segmentBody)).to.equal(shaBody[segmentName]);
    });
}
...
function checkResolutionsInMasterPlaylist(options) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        for (const resolution of resolutions) {
            ...
            (0, chai_1.expect)(masterPlaylist).to.match(reg);
        }
    });
}
